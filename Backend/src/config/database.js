        ...
        db.run(
          ...
          [
            ...
            JSON.stringify({
              ...
              Ubicacion: "Datacenter - Sala3, Rack 031.025, Unidades 7-6",
            }),
          ]
        );
        db.run(
          ...
          [
            ...
            JSON.stringify({
              ...
              MarcaModelo: "VMware ESXi VM",
              Tipo: "Standalone",
              Estado: "Activo",
              Serial: "VMX20250903001",
              FirmwareVersionSO: "Ubuntu Server 22.04 LTS",
              IP_URL_Mgnt: "192.168.200.20",
              IP_Adicionales: "10.0.20.15, 10.0.20.16",
              Ubicacion: "Datacenter - Sala2, Rack 020.010, Unidad 5",
            }),
          ]
        );
        db.run(
          ...
          [
            ...
            JSON.stringify({
              ...
              MarcaModelo: "Dell PowerEdge R740",
              Tipo: "Standalone",
              Estado: "Producción",
              Serial: "SN12345SQL001",
              FirmwareVersionSO: "Windows Server 2019 Datacenter",
              IP_URL_Mgnt: "192.168.200.30",
              IP_Adicionales: "10.0.30.10, 10.0.30.11",
              Ubicacion: "Datacenter - Sala1, Rack 010.005, Unidad 12",
            }),
          ]
        );
      }
        ...
        db.run(
          ...
          [
            ...
            JSON.stringify({
              ...
              FirmwareVersionSO: "CentOS 8",
              IP_URL_Mgnt: "192.168.210.40",
              IP_Adicionales: "10.0.40.20, 10.0.40.21",
              Ubicacion: "Datacenter - Sala2, Rack 022.012, Unidad 4",
            }),
          ]
        );
        db.run(
          ...
          [
            ...
            JSON.stringify({
              ...
              MarcaModelo: "HP ProLiant DL380 Gen10",
              Tipo: "Standalone",
              Estado: "Producción",
              Serial: "HPMX20250903011",
              FirmwareVersionSO: "Windows Server 2022",
              IP_URL_Mgnt: "192.168.210.41",
              IP_Adicionales: "10.0.41.10, 10.0.41.11",
              Ubicacion: "Datacenter - Sala1, Rack 015.020, Unidad 7",
            }),
          ]
        );
        db.run(
          ...
          [
            ...
            JSON.stringify({
              ...
              MarcaModelo: "Lenovo ThinkSystem SR650",
              Tipo: "Standalone",
              Estado: "Activo",
              Serial: "LEN20250903012",
              FirmwareVersionSO: "Debian 11",
              IP_URL_Mgnt: "192.168.210.42",
              IP_Adicionales: "10.0.42.15, 10.0.42.16",
              Ubicacion: "Datacenter - Sala3, Rack 030.018, Unidad 9",
            }),
          ]
        );
        db.run(
          ...
          [
            ...
            JSON.stringify({
              ...
              MarcaModelo: "FortiGate 200E",
              Tipo: "Standalone",
              Estado: "Activo",
              Serial: "FGT20250903013",
              FirmwareVersionSO: "FortiOS v7.0.5, build0366",
              IP_URL_Mgnt: "192.168.210.43",
              IP_Adicionales: "10.0.43.5, 10.0.43.6",
              Ubicacion: "Datacenter - Sala3, Rack 033.014, Unidad 2",
            }),
          ]
        );
      }
